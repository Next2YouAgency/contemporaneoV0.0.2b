            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <select name="FormaPagamento" id="FormaPagamento<?php echo $ReturnPagamentos[id] ?>" class="form-control" onchange="ChequeSelecionado<?php echo $ReturnPagamentos[id] ?>()">
                    ...
                    <div id="returmMetodoPagamento<?php echo $ReturnPagamentos[id] ?>">
                        <div class="form-group col-md-2">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="SalvarPagamentos">Salvar Pagamento</button>
                </div>
            </div>
        </form>
    </div>
